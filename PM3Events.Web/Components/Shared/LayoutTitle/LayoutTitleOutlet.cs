...
namespace PM3Events.Web.Components.Shared.LayoutTitle
{
    public sealed class LayoutTitleOutlet : ComponentBase
    {
        ...
        internal static readonly object LayoutTitleSectionId = new();
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            builder.AddComponentParameter(7, nameof(SectionOutlet.SectionId), LayoutTitleSectionId);
            builder.CloseComponent();
        }
        ...
        private void BuildDefaultTitleRenderTree(RenderTreeBuilder builder)
        {
            ...
            builder.AddContent(0, _defaultTitle);
